...
import 'add_enterprise_screen.dart';   // ← New screen
...
class _SupervisorDashboardState extends State<SupervisorDashboard> {
  ...
  Future<void> _loadData() async {
    ...
    final ip = 'http://192.168.43.231:5000';   // ← Your IP
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _statCard('Visits', totalVisits.toString(), Icons.history),
                    ],
                  ),
                  ...
                  ElevatedButton.icon(
                    ...
                    label: const Text('Assign Enterprise to Coach'),
                    style: ElevatedButton.styleFrom(minimumSize: const Size(double.infinity, 60)),
                    onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AssignEnterpriseScreen())),
                  ),
                  const SizedBox(height: 10),
                  ElevatedButton.icon(
                    icon: const Icon(Icons.add_business),
                    label: const Text('Add New Enterprise'),
                    style: ElevatedButton.styleFrom(minimumSize: const Size(double.infinity, 60)),
                    onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AddEnterpriseScreen())),
                  ),
                  const SizedBox(height: 10),
                  ElevatedButton.icon(
                    icon: const Icon(Icons.checklist),
                    label: const Text('QC Queue'),
                    style: ElevatedButton.styleFrom(minimumSize: const Size(double.infinity, 60)),
